            ...
            <div class="table-responsive">
                ...
                ?>
                    ...
                    <?php
                        ...
                        $grandTotal = 0;
                        foreach ($rows as $row):
                            $row->subtotal = $row->yuan_price * $row->quantity;
                            ...
                            <tr>
                                ...
                                <td style="text-align:right; width:100px;">
                                    <?=$this->sma->formatMoney($row->yuan_price);?>
                                </td>
                                <?php
                                    if ($Settings->tax1 && $inv->product_tax > 0) {
                        ...
                        if ($return_rows) {
                            ...
                            ?>
                                ...
                                ?>
                                    ...
                                    <td style="text-align:right; width:100px;"><?=$this->sma->formatMoney($row->yuan_price); ?></td>
                                    <?php
                                        if ($Settings->tax1 && $inv->product_tax > 0) {
                                            echo '<td style="width: 100px; text-align:right; vertical-align:middle;">' . ($row->item_tax != 0 ? '<small>(' . ($Settings->indian_gst ? $row->tax : $row->tax_code) . ')</small> ' : '') . $this->sma->formatMoney($row->item_tax) . '</td>';
                                        }
